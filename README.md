...
|[yjPlay][121]|一个支持自定义布局和直播 手势 亮度，音量，快进，等手势 ，广告视频预览 ，清晰度切换 ， 边播放缓存视频， 自定义各种数据源加载，列表播放,倍数播放 的播放器。<br>![](https://github.com/yangchaojiang/yjPlay/raw/master/test.gif)| 
...
|[CircleDemo][117]|仿微信(weixin wechat)实现的朋友圈，模拟与后台交互实现了点赞、评论、删除等功能，RecyclerView可以根据键盘的显示或隐藏实现联动。增加短视频拍摄功能，与后台交互采用mvp模式。关键字：wechat weixin 微信朋友圈<br>![](https://github.com/Naoki2015/CircleDemo/raw/master/CircleDemo/imgs/2.png)| 
